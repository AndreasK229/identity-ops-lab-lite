...
This is the public community/demo edition. It intentionally avoids live Entra execution, Microsoft Graph writes, scoring, premium scenario packs, hosted SaaS behavior, tenant mapping automation, and advanced autonomous persona generation.
...
You are the IAM Support Operator. The simulator gives you realistic evidence, not hidden scenario truth. Use the ticket queue, employee profile, sign-in logs, audit log, checklist, remediation actions, and ticket conversation to diagnose each case.
...
- There are no real secrets, tenant IDs, Microsoft Graph writes, Entra integration, tenant mapping jobs, hosted multi-tenant paths, scoring engines, or premium scenario packs.
